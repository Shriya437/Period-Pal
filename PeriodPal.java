     ...
     while (true) {
       ...
       switch (choice2) {
         ...
         case 8:
           ...
           break;
         case 9:
           System.out.println("\u001B[95;1m" + "		Thank you for using Period Pal! \n		Stay well!" + "\u001B[0m");
           System.exit(0);
           break;
         default:
...
private static void updatePeriodDate(Scanner sc, Phase p) {
 ...
 while (!validDate) {
   try {
     ...
     if (p.lastPeriodDate == null || newDate.isBefore(p.lastPeriodDate.toLocalDate()) || newDate.isAfter(LocalDate.now())) {
...
String identifyPrakriti(Scanner sc) {
 ...
 questions.add(new Question("Your body frame is:", "Thin and light", "Medium and muscular", "Broad and heavy"));
 questions.add(new Question("Your skin tends to be:", "Dry and rough", "Warm and oily", "Smooth and cold"));
...
void displayLoggedPeriodDate() {
 try (BufferedReader reader = new BufferedReader(new FileReader("Period_Date_log.txt"))) {
   ...
   System.out.println("\u001B[91m" + "Period dates haven't been logged yet." + "\u001B[0m");
 }
}
void updatePeriodsDate(LocalDate newDate) {
 DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd/MM/yy");
 lastPeriodDate = newDate.atStartOfDay(zone);
 System.out.println("\u001B[92m" + "Updated period date is: " + lastPeriodDate.format(formatter) + "\u001B[0m");
...
void checkPhase() {
 ...
 if (difference < periodLength) {
   System.out.println(
       "\u001B[38;5;93m" + (periodLength - difference - 1) + " days left for periods to finish!" + "\u001B[0m");
 } else if (difference < cycleLength) {
   System.out.println("\u001B[38;5;93m" + (cycleLength - ChronoUnit.DAYS.between(lastPeriodDate, today))
       + " days left for periods to come!" + "\u001B[0m");
 } else {
   System.out.println("\u001B[38;5;93m" + "Your period is late by "
       + Math.abs(cycleLength - ChronoUnit.DAYS.between(lastPeriodDate, today)) + " days!" + "\u001B[0m");
...
void updateProfile(Scanner sc) {
 ...
 switch (choice) {
   case 1:
     ...
     break;
   case 2:
     System.out.print("\u001B[94m" + "Enter your prakriti(vata, kapha, pitta, vata-kapha, vata-pitta, pitta-kapha: " + "\u001B[0m");
     prakriti = sc.nextLine();
     saveProfileToFile();
     break;
   case 3:
...
public void display() {
 if (nextPeriod == 14) {
   System.out.println("\u001B[91m" + "You are ovulating today!" + "\u001B[0m");
 } else if (nextPeriod <= 5) {
   System.out.println("\u001B[91m" + "You are in the PMS phase!" + "\u001B[0m");
 } else if (nextPeriod <= 19 && nextPeriod >= 13 && nextPeriod != 14) {
   System.out.println("\u001B[91m" + "You are in the fertile phase!" + "\u001B[0m");
 } else if (nextPeriod >= 6 && nextPeriod <= 12) {
   System.out.println("\u001B[91m" + "You are in the luteal phase!" + "\u001B[0m");
 } else if (nextPeriod >= 20 && nextPeriod <= (cycleLength - periodLength)) {
   System.out.println("\u001B[91m" + "You are in the follicular phase!" + "\u001B[0m");
 } else {
   System.out.println("\u001B[91m" + "You are in the menstrual phase!" + "\u001B[0m");
 }
}
}
...
void displayJokesandMyths() {
 System.out.println();
 System.out.println("\u001B[92m" + "Here's a joke just for you, " + phase.name + "!\n" + "\u001B[0m");
 UserBase.delay(1000);
 ...
 UserBase.delay(2000);
 System.out.println();
 System.out.println("\u001B[92m" + "Here's a myth buster just for you," + phase.name + "!\n" + "\u001B[0m");
 UserBase.delay(1000);
...
private void saveMythsToFile(String myth) {
 try (BufferedWriter writer = new BufferedWriter(new FileWriter("myths_log.txt", true))) {
   ...
   System.out.println("\u001B[91m" + "Error saving mood update: " + e.getMessage() + "\u001B[0m");
 }
}
void displayLoggedMyths() {
 try (BufferedReader reader = new BufferedReader(new FileReader("myths_log.txt"))) {
   String line;
   System.out.println("\u001B[96m" + "Logged Myth Busters  : " + "\u001B[0m");
   System.out.println("-----------------------------");
   while ((line = reader.readLine()) != null) {
     System.out.println("\u001B[38;5;93m" + "  " + line  + "\u001B[0m");
   }
   ...
   System.out.println("\u001B[91m" + "Error reading files : " + e.getMessage() + "\u001B[0m");
 }
}
}
...
private void saveDietToFile(String dietList) {
 try (BufferedWriter writer = new BufferedWriter(new FileWriter(DIET_LOG_FILE, true))) {
   ...
   System.out.println("\u001B[91m" + "Error saving diet data: " + e.getMessage() + "\u001B[0m");
 }
}
...
final static void addmsgs() {
 ...
 msgs_sad.add("This too shall pass. One soft moment at a time, %s 💫");
 ...
 msgs_nervous.add("Everything will work out, %s! One moment at a time 🌤️");
...
void displaymsg() {
 System.out.println(
     "\u001B[94;1m" + "How are you feeling today, " + phase.name + "? Please select an option below:" + "\u001B[0m");
...
void symptoms(Scanner sc) {
 while (true) {
   if (phase.today.isEqual(phase.lastPeriodDate)
     ...
     System.out.println("\u001B[96m" + "9. Exit Symptoms Section" + "\u001B[0m");
     ...
     switch (symptomChoice) {
       case 1:
         System.out.println("\u001B[92m"
             + "You are experiencing cramps. Consider using a heating pad for relief." + "\u001B[0m");
         symptomLog = "Cramps";
         break;
       case 2:
         System.out.println("\u001B[92m"
             + "Bloating can be uncomfortable. Try drinking herbal tea to ease it." + "\u001B[0m");
         symptomLog = "Bloating";
         break;
       case 3:
         System.out.println(
         ...
         break;
       case 4:
         System.out.println("\u001B[92m" + "Fatigue is normal during this time. Ensure you get enough rest."
             + "\u001B[0m");
         symptomLog = "Fatigue";
         break;
       case 5:
         ...
         break;
       case 6:
         System.out.println("\u001B[92m" + "Nausea can be tough. Ginger tea may help settle your stomach."
             + "\u001B[0m");
         symptomLog = "Nausea";
         break;
       case 7:
         System.out
             .println("\u001B[92m" + "Back pain can be relieved with gentle stretching." + "\u001B[0m");
         symptomLog = "Back Pain";
         break;
       case 8:
         System.out.print("\u001B[94m" + "Please describe your symptoms: " + "\u001B[0m");
         String otherSymptoms = sc.nextLine();
         System.out.println("\u001B[92m" + "You mentioned: " + otherSymptoms
             + ". It's always good to consult a healthcare provider." + "\u001B[0m");
         symptomLog = "Other: " + otherSymptoms;
         break;
       case 9: // Exit option
         System.out.println("\u001B[95m" + "Exiting symptoms section." + "\u001B[0m");
         return;
       default:
         System.out.println("\u001B[91m" + "Invalid choice. Please try again." + "\u001B[0m");
         continue;
     ...
     System.out.println("\u001B[94m" + "You are not in your period right now . No symptoms to report currently." + "\u001B[0m");
     return;
   }
 }
}
private void logSymptom(String symptom) {
 try (BufferedWriter writer = new BufferedWriter(new FileWriter("symptoms_log.txt", true))) {
   ...
   System.out.println("\u001B[96m" + "You are not in your period right now, so no symptoms to log" + "\u001B[0m");
 }
}
